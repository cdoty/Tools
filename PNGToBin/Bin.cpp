...
Bin::Ptr Bin::create(const std::string& _strFilename, const std::string& _strStartY, const std::string& _strEndY, const std::string& _strTiles)
{
	INSTANCE(pBin, Bin())

	if (false == pBin->initialize(_strFilename, _strStartY, _strEndY, _strTiles))
	{
		pBin.reset();
	}
...
bool Bin::initialize(const std::string& _strFilename, const std::string& _strStartY, const std::string& _strEndY, const std::string& _strTiles)
{
...
bool Bin::bufferSame(uint8_t* _pBuffer1, uint8_t* _pBuffer2, int _iBufferSize)
{
