...
class Bin
{
	public:
		...
		// Create
		static Ptr create(const std::string& _strFilename, const std::string& _strStartY, const std::string& _strEndY, const std::string& _strTiles, int _iStartingTile);

		// Initialize
		bool initialize(const std::string& _strFilename, const std::string& _strStartY, const std::string& _strEndY, const std::string& _strTiles, int _iStartingTile);
